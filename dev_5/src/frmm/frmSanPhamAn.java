...
public class frmSanPhamAn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblSanPham_spa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Ma San Pham ", "Ten San Pham", "Loai San Pham", "Gia Nhap", "Gia Ban", "Nha San Xuat", "Ton Kho", "IMG", "Chu Thich"
            }
        ) {
        ...
        jLabel7.setText("San Pham Da Ban");
    ...
    private void tblSanPham_spaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham_spaMouseClicked
        ...
        thienAn.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 3).toString(), cbbMaLoaiSanPham_SanPhamAn);
        thienAn.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 6).toString(), cbbHangSanXuat_SanPhamAn);
    ...
    private void jPanelSanPham_spaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelSanPham_spaComponentShown
       LayDuLieuSanPham("0");
        ...
        cbbMaLoaiSanPham_SanPhamAn.setModel(thienAn.frmTC.LayDuLieucbb("LoaiSanPham", "TenLoaiSanPham", "MaLoaiSanPham"));
        cbbHangSanXuat_SanPhamAn.setModel(thienAn.frmTC.LayDuLieucbb("HangSanXuat", "TenHangSanXuat", "MaHangSanXuat"));
    ...
    private void btnHienlai_SanPhamAnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHienlai_SanPhamAnActionPerformed
        ...
        if (kiemtra) {
        	...
        	thienAn.frmTC.ThongBao("That Bai", "San Pham", 2);
        }
      LayDuLieuSanPham("0");
      ResSanPham();
  ...
  public void ResSanPham(){
    ...
    public void LayDuLieuSanPham(String TrangThai) {
        String cautruyvan = "";
        System.out.println("376 san pham");
        ...
        Object[] obj = new Object[]{"STT", "Ma San Pham", "Ten San Pham", "Loai San Pham", "Gia Nhap", "Gia Ban", "Hang San Xuat", "Ton Kho","IMG", "Chu Thich"};
